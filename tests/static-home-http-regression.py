...
def main():
    # docker/gen_config.php deliberately rewrites config.php while Apache runs.
    # Later preservation suites must see the source, not this fixture's output.
    with preserve_source_config(ROOT):
        run_native()
