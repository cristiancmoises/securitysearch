 ...
 with tempfile.TemporaryFile()as log:
  ...
  try:
   ...
   for theme in ['Tron','SecOps','Gentoo','Art','Lain','Stop','Dark','Wine','The Birthday Massacre']:
    ...
    ok(c==200 and '/themes/'+expected+'.css?v27'in b and '<script'not in b,'Native theme '+theme)
   ...
   c,h,b=req('/fixture-images',cookie='theme=Tron');ok(c==200 and 'data-motion='in b and 'images-motion.js?v27'in b,'Actual image renderer / fixture transport')
   ok('experience.css?v27'in b and "connect-src 'self'"in h['Content-Security-Policy'],'Image CSS and scoped policy')
