...
spec = importlib.util.spec_from_file_location("publisher", Path(__file__).resolve().parents[1] / "scripts/publish-v0.9.42.py")
...
class GitAndArchiveTests(unittest.TestCase):
    ...
    def git(self, repo, *args):
        result = subprocess.run(["git", "-c", "gc.auto=0", "-c", "gc.autoDetach=false", "-c", "maintenance.auto=false", "-C", str(repo), *args], stdout=subprocess.PIPE, stderr=subprocess.PIPE, env=p.safe_environment(), check=True)
...
class PackageTests(unittest.TestCase):
    def setUp(self):
        ...
        for name in ('README.md', 'README.pt-BR.md', 'data/audit-baseline-0.9.36.json', 'data/audit-baseline-0.9.37.json', 'data/audit-commands-0.9.38.json', 'data/audit-commands-0.9.40.json', 'data/audit-commands-0.9.41.json', 'data/audit-commands-0.9.42.json', 'data/preserved-runtime-0.9.38.json', 'data/release-version.txt', 'data/runtime-changes-0.9.41.json', 'data/runtime-changes-0.9.42.json', 'data/search-state-changes-0.9.40.json', 'data/upgrade-baseline-0.9.30.json', 'docker/apache/fast-home.conf', 'docker/apache/fpm.conf', 'docker/apache/precompressed-assets.conf', 'docker/php-fpm/php-fpm.conf', 'docker/php-fpm/securitysearch.conf', 'docs/AUDIT-0.9.40.md', 'docs/AUDIT-0.9.42.md', 'docs/AUDITFIX-0.9.20-r1.md', 'docs/AUDITFIX-0.9.40-r1.md', 'docs/AUDITFIX-0.9.40-r2.md', 'docs/INDEX.md', 'docs/OPERATIONS-0.9.40.md', 'docs/OPERATIONS-0.9.40.pt-BR.md', 'docs/OPERATIONS-0.9.42.md', 'docs/OPERATIONS-0.9.42.pt-BR.md', 'docs/PERFORMANCE-0.9.40.md', 'docs/PERFORMANCE-0.9.42.md', 'docs/PUBLISHING.md', 'docs/PUBLISHING.pt-BR.md', 'docs/RELEASE-0.9.40.md', 'docs/RELEASE-0.9.42.md', 'docs/RELEASE.md', 'docs/RESEARCH-0.9.42.md', 'docs/RETENTION.md', 'docs/SKUNKYART.md', 'docs/TROUBLESHOOTING-0.9.40.md', 'docs/TROUBLESHOOTING-0.9.42.md', 'docs/UPGRADE-0.9.30-to-0.9.40.md', 'docs/UPGRADE-0.9.30-to-0.9.42.md', 'docs/screenshots/securitysearch-0.9.21-home-black.png', 'docs/screenshots/securitysearch-0.9.21-theme-picker.png', 'docs/screenshots/securitysearch-0.9.36-home.png', 'docs/screenshots/securitysearch-0.9.36-mobile.png', 'lib/build_home_snapshot.php', 'lib/build_static_assets.php', 'lib/build_view_resources.php', 'lib/favicon_cache.php', 'lib/favicon_policy.php', 'lib/google_cse_protocol.php', 'lib/image_results.php', 'lib/news_rss.php', 'lib/news_selection.php', 'lib/news_sources.php', 'lib/page_renderer.php', 'lib/redlib_selection.php', 'lib/thumbnail_png.php', 'lib/view_resources.php', 'proxy.php', 'scraper/newswire.php', 'scraper/skunkyart.php', 'scripts/audit_evidence.py', 'scripts/audit_stream.py', 'scripts/delivery-profile.php', 'scripts/delivery-profile.py', 'scripts/deploy-ionos.fish', 'scripts/deployment_state.py', 'scripts/news-rss-probe.php', 'scripts/operator_payload.py', 'scripts/package-v0.9.40.py', 'scripts/package-v0.9.42.py', 'scripts/postdeploy_cleanup.py', 'scripts/predeploy_cleanup.py', 'scripts/production_guard.py', 'scripts/publish-v0.9.40.py', 'scripts/publish-v0.9.42.py', 'scripts/push-securitysearch.fish', 'scripts/redlib-probe.php', 'static/images-infinite.js', 'tests/audit-evidence-regression.py', 'tests/audit-only-regression.py', 'tests/audit-stream-regression.py', 'tests/audit_fixture.py', 'tests/cleanup-inventory-regression.py', 'tests/delivery-analysis-regression.py', 'tests/favicon-cache-http-regression.py', 'tests/favicon-cache-regression.php', 'tests/favicon-http-regression.py', 'tests/favicon-performance-regression.php', 'tests/fixtures/thumbnail_http_fixture.py', 'tests/fpm-native-regression.py', 'tests/fpm-runtime-regression.py', 'tests/google-flow-regression.php', 'tests/google-live-gate-regression.py', 'tests/home-representation-http-regression.py', 'tests/http-runtime-regression.py', 'tests/http_runtime.py', 'tests/image-label-regression.php', 'tests/image-preview-http-regression.py', 'tests/image-preview-regression.php', 'tests/native_config_fixture.py', 'tests/news-primary-regression.php', 'tests/operator-payload-regression.py', 'tests/picture-http-regression.py', 'tests/postdeploy-cleanup-regression.py', 'tests/production-guard-regression.py', 'tests/provider-http-harness-regression.py', 'tests/publication-v0.9.42-regression.py', 'tests/release-37-contracts.py', 'tests/release-38-contracts.py', 'tests/release-40-contracts.py', 'tests/release-41-contracts.py', 'tests/release-42-contracts.py', 'tests/runtime_history.py', 'tests/search-hotpath-regression.php', 'tests/search-state-http-regression.py', 'tests/search-state-regression.php', 'tests/single-deploy-regression.py', 'tests/skunkyart-http-regression.py', 'tests/skunkyart-regression.php', 'tests/static-assets-http-regression.py', 'tests/static-assets-regression.py', 'tests/static-home-http-regression.py', 'tests/static-home-regression.py', 'tests/thumbnail-http-regression.py', 'tests/thumbnail-native-regression.py', 'tests/thumbnail-png-regression.php', 'tools/analyze-delivery.py', 'tools/secops-web-benchmark-v3.fish', 'tools/secops-web-benchmark-v4.fish', 'tools/ttfb_benchmark.py'):
            target = self.repo/name
            target.parent.mkdir(parents=True, exist_ok=True)
            target.write_text("0.9.42" if name.endswith("release-version.txt") else "fixture")
        for name in ("scripts/publish-v0.9.42.py", "scripts/package-v0.9.42.py", "scripts/release_media_policy.py"):
            target = self.repo/name
            target.parent.mkdir(parents=True, exist_ok=True)
            target.write_bytes((source/name).read_bytes())
        self.g("add", ".")
        self.g("-c", "commit.gpgsign=false", "commit", "-m", "release fixture")
        self.g("-c", "tag.gpgsign=false", "tag", "-a", "v0.9.42", "-m", "fixture tag")
        spec = importlib.util.spec_from_file_location("packager", source/"scripts/package-v0.9.42.py")
    ...
    def g(self, *args):
        return subprocess.check_output(["git", "-c", "gc.auto=0", "-c", "gc.autoDetach=false", "-c", "maintenance.auto=false", "-C", str(self.repo), *args], stderr=subprocess.DEVNULL,
    ...
    def test_package_checksum_provenance_bundle_and_repeat(self):
        ...
        self.assertEqual(manifest['asset_version'],42)
        self.assertEqual(manifest['commit'],self.g('rev-parse','HEAD').decode().strip())
        self.g('bundle','verify',str(self.output/'securitysearch-v0.9.42.bundle'))
        p.prepare(self.repo,self.output,self.repo/'docs/RELEASE-0.9.42.md')
    ...
    def test_dirty_checkout_has_no_tag_or_package_side_effect(self):
        before=self.g('rev-parse','refs/tags/v0.9.42')
        (self.repo/'README.md').write_text('private local changes')
        with self.assertRaises(self.builder.Failure):
            self.builder.package(self.repo,self.output)
        self.assertEqual(before,self.g('rev-parse','refs/tags/v0.9.42'))
    ...
    def test_generated_resources_rejected_even_if_force_tracked(self):
        file=self.repo/'data/view-resources.generated.php';file.write_text('<?php return [];')
        self.g('add','-f',str(file))
        self.g('-c','commit.gpgsign=false','commit','-m','fixture generated content')
        with self.assertRaisesRegex(self.builder.Failure,'Generated view resources'):
            self.builder.source_archive(self.repo,self.g('rev-parse','HEAD').decode().strip())
