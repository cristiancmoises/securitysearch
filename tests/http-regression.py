...
''')
        ...
        with (root/'server.log').open('w+') as log:
            ...
            try:
                ...
                assert '/static/themes/Black.css?v24' in html and html.count('class="search-action-icon"')==4
                ...
                for view in ['grid','compact','gallery','feed','list','filmstrip']:
                    ...
                    assert 'images-view-'+view in html and '/static/images-infinite.js?v24' in html
                ...
                assert '<script' not in html and url and '/static/themes/Lain.css?v24' in html
