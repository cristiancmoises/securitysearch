...
try {
 ...
 if(config::SERVER_NAME!==$marker || config::API_ENABLED!==false || defined('config::UNKNOWN') || config::REDLIB_FALLBACKS!==false || config::REDLIB_PRIMARY!=='https://redlib.nadeko.net' || config::VERSION!==27 || config::DEFAULT_THEME!=="Black"){throw new RuntimeException('Configuration literals/types changed');}
