...
run_test python3 tests/static-assets-regression.py
run_test python3 tests/static-assets-http-regression.py
run_test python3 tests/delivery-analysis-regression.py
run_test python3 tests/publication-v0.9.31-regression.py
run_test python3 tests/predeploy-cleanup-regression.py
run_test python3 tests/deployment-state-regression.py
run_test python3 tests/release-32-contracts.py
run_test python3 tests/publication-v0.9.32-regression.py
run_test python3 tests/cleanup-inventory-regression.py
run_test python3 tests/production-guard-regression.py
run_test python3 tests/release-33-contracts.py
run_test python3 tests/publication-v0.9.33-regression.py
run_test php tests/favicon-cache-regression.php
run_test python3 tests/favicon-cache-http-regression.py
run_test python3 tests/release-34-contracts.py
run_test python3 tests/publication-v0.9.34-regression.py
run_test php tests/thumbnail-png-regression.php
run_test python3 tests/thumbnail-http-regression.py
run_test python3 tests/thumbnail-native-regression.py
run_test python3 tests/release-35-contracts.py
run_test python3 tests/publication-v0.9.35-regression.py
run_test php tests/image-preview-regression.php
run_test python3 tests/image-preview-http-regression.py
run_test python3 tests/release-36-contracts.py
run_test python3 tests/publication-v0.9.36-regression.py
run_test python3 tests/operator-payload-regression.py
run_test python3 tests/http-runtime-regression.py
run_test python3 tests/release-37-contracts.py
run_test python3 tests/publication-v0.9.37-regression.py
run_test python3 tests/audit-evidence-regression.py
run_test python3 tests/audit-stream-regression.py
run_test python3 tests/audit-only-regression.py
run_test python3 tests/release-38-contracts.py
run_test python3 tests/publication-v0.9.38-regression.py
run_test php tests/search-state-regression.php
