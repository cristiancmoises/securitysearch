#!/usr/bin/env python3
"""Build immutable source assets and an incremental recovery bundle from v0.9.40.
...
def source_archive(repo, commit):
    ...
    required = {'docs/INDEX.md', 'docs/UPGRADE-0.9.30-to-0.9.40.md', 'docs/OPERATIONS-0.9.40.md', 'docs/OPERATIONS-0.9.40.pt-BR.md', 'docs/PUBLISHING.md', 'docs/PUBLISHING.pt-BR.md', 'docs/TROUBLESHOOTING-0.9.40.md', 'docs/RELEASE.md', 'data/upgrade-baseline-0.9.30.json', 'README.pt-BR.md', 'tests/search-state-regression.php', 'tests/search-state-http-regression.py', 'tests/release-40-contracts.py', 'tests/runtime_history.py', 'tests/native_config_fixture.py', 'docs/AUDITFIX-0.9.40-r1.md', 'docs/AUDITFIX-0.9.40-r2.md', 'data/search-state-changes-0.9.40.json', 'data/audit-commands-0.9.38.json', 'tests/audit_fixture.py', 'data/audit-baseline-0.9.37.json', 'scripts/audit_evidence.py', 'scripts/audit_stream.py', 'data/audit-commands-0.9.40.json', 'tests/audit-evidence-regression.py', 'tests/audit-stream-regression.py', 'tests/audit-only-regression.py', 'tests/release-38-contracts.py', 'scripts/operator_payload.py', 'tests/operator-payload-regression.py', 'tests/http_runtime.py', 'tests/http-runtime-regression.py', 'tests/release-37-contracts.py', 'data/audit-baseline-0.9.36.json', 'data/preserved-runtime-0.9.38.json', 'README.md', 'README.pt-BR.md', 'data/release-version.txt',
                ...
                'docs/RELEASE-0.9.40.md', 'docs/PERFORMANCE-0.9.40.md', 'docs/AUDIT-0.9.40.md', 'docs/AUDITFIX-0.9.20-r1.md',
                'scripts/publish-v0.9.40.py', 'scripts/package-v0.9.40.py',
                ...
                'scripts/delivery-profile.php', 'scripts/delivery-profile.py', 'docs/PERFORMANCE-0.9.40.md',
...
def package(repo, outdir):
    ...
    files = {archive_name: source, archive_name + '.sha256': checksum,
             ...
             'RELEASE-0.9.40.md': git(repo, 'show', commit + ':docs/RELEASE-0.9.40.md')}
    ...
    spec = importlib.util.spec_from_file_location('release_publisher', repo / 'scripts/publish-v0.9.40.py')
    publisher = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(publisher)
    publisher.prepare(repo, outdir, repo / 'docs/RELEASE-0.9.40.md')
...
def main():
    ...
    return package(repo, args.output or repo.parent / 'securitysearch-release-v0.9.40')
