# Historical documentation — v0.9.14 and earlier

Use the current README and v0.9.15 operations guide for this release.
...
Integrated Invidious and Binternet search, bounded high-quality image previews, requested navigation/footer, stronger proxy address checks, private access logging, and an IONOS updater with candidate validation and rollback.

[Operations / deployment](docs/OPERATIONS-0.9.14.md) · [Português](docs/OPERATIONS-0.9.14.pt-BR.md) · [Audit and measured validation](docs/AUDIT-0.9.14.md).

The removed Lain wallpaper is now a static black/cyan background. The older release notes below describe historical behavior.


## Previous source version: v0.9.13
...
The v0.9.10 source keeps the existing network model (host port `5140` → container
